...
const BasicDetails = ({}) => {
  ...
  const [createAppBasicDetails, { isLoadging: createLoading }] =
    useCreateAppBasicDetailsMutation();
  const { data: appBasicDetails, isLoadging: detailsLoading } =
    useGetAppBasicDetailsQuery({
  ...
  useEffect(() => {
    setCurrentStep(0);
    setBasicDetails(appBasicDetails?.basicDetails || initState);
  }, []);
  ...
  const handleNext = async (e) => {
    ...
    try {
      ...
      await createAppBasicDetails(basicDetails).unwrap();
            ...
            <Grid container spacing={isMobile ? 2 : 5} sx={{ p: "0" }}>
              ...
              <Grid item xs={12} sm={6}>
                ...
                <DatePicker
                  ...
                  onChange={(value) =>
                    setBasicDetails({ ...basicDetails, dateOfBirth: value.$d })
                  }
                  sx={{
                    width: "100%",
                    backgroundColor: (theme) => theme.palette.background.main,
